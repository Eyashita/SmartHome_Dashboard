...
# Create a Streamlit interval to refresh data every 1 seconds
...
with col1:
    date1 = pd.Timestamp(st.date_input("Start Date", startDate))
with col2:
    date2 = pd.Timestamp(st.date_input("End Date", endDate))
